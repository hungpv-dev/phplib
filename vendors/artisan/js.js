  ...
  let content = data.map((item,index) => {
      return `
          <tr>
            ...
            <td class="username align-middle white-space-nowrap text-center">${item.d_name}</td>
            <td class="username align-middle white-space-nowrap text-center">${item.status == 0 ? 'Hoạt động' : 'Đã khóa'}</td>
            ...
            <td class="align-middle white-space-nowrap text-center d-flex pe-0">
                ...
                <div class="position-relative">
                    <a href="" class="btn btn-edit-show btn-sm btn-phoenix-secondary text-info me-1 fs-10" title="Phân quyền user" type="button" data-bs-toggle="modal" data-bs-target="#editModel">
