...
<body>
    ...
    <main class="main" id="top">
        ...
        <div class="content">
            ...
            <h2 class="text-bold text-body-emphasis mb-5">Quản lý nhà cung cấp</h2>
            <div>
                <!-- Search -->
                    ...
                    <div class="col-auto">
                        <div class="d-flex align-items-center ">
                            ...
                            <button class="btn btn-primary px-3" data-bs-toggle="modal" data-bs-target="#addModel">
                                <span class="fas fa-plus me-2"></span>Nhà cung cấp
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover table-sm fs-9 mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort align-middle text-start" scope="col" data-sort="customer" style="max-width:160px">Người đại diện</th>
                                    <th class="sort align-middle text-start" scope="col" data-sort="email" style="max-width: 200px">Công ty</th>
                                    <th class="sort align-middle text-start" scope="col" data-sort="role" style="max-width:160px">Email</th>
                                    <th class="sort align-middle text-start" scope="col" data-sort="last_active" style="max-width: 200px">Địa chỉ</th>
                                    <th class="sort align-middle text-start" scope="col" data-sort="last_active" style="max-width: 200px">Số điện thoại</th>
                                    <th class="sort align-middle text-start" scope="col" data-sort="last_active" style="max-width: 200px">Loại nhà cung cấp</th>
                                    <th class="sort align-middle text-start" scope="col" data-sort="last_active" style="max-width: 200px">Trạng thái</th>
                                ...
                                <form class="row g-3" id="formAdd" method="POST">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-floating">
                                            <input class="form-control" type="text" disabled value="<?= $_SESSION['authentication']->name ?>" placeholder="Nhân viên phụ trách" />
                                            <label>Nhân viên phụ trách</label>
                                        </div>
                                    </div>
                                    <input type="hidden" class="data-value" value="<?= $_SESSION['authentication']->id ?>" name="user_id">

                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-floating">
                                            <input class="form-control data-value data-validate" name="name" type="text" placeholder="người đại diện" />
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-floating">
                                            <select name="type" title="loại nhà cung cấp" class="form-select data-value data-validate">
                                                <option value="1">Nhà cung cấp vật liệu</option>
                                                <option value="2">Nhà cung cấp dịch vụ</option>
                                            </select>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-floating">
                                            <select name="status" trạng thái="" class="form-select data-value data-validate">
                                                <option value="0">Hợp tác</option>
                                                <option value="1">Ngừng hợp tác</option>
                                            </select>
            ...
            <div class="modal fade" id="editModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Cập nhật cung cấp</h5>
                                <button class="btn p-1 closeButton" type="button" data-bs-dismiss="modal" aria-label="Close">
                                    <svg class="svg-inline--fa fa-xmark fs-9" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="xmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                                        <path fill="currentColor" d="M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z"></path>
                                    </svg>
                            ...
                            <div class="modal-body">
                                ...
                                <form class="row g-3" id="formEdit" method="POST">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-floating">
                                            <input class="form-control" type="text" disabled name="user_name" placeholder="Nhân viên phụ trách" />
                                            <label>Nhân viên phụ trách</label>
                                        </div>
                                    </div>
                                    <input type="hidden" class="data-value" name="user_id">
            ...
            <script src="./inc/scripts/suppliers.js"></script>
            <!-- Footer-->
