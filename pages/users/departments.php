...
<body>
    ...
    <main class="main" id="top">
        ...
        <div class="content">
            ...
            <h2 class="text-bold text-body-emphasis mb-5">Quản lý phòng ban</h2>
            <div>
                <!-- Search -->
                    ...
                    <div class="col-auto">
                        <div class="d-flex align-items-center ">
                            ...
                            <button class="btn btn-primary px-3" data-bs-toggle="modal" data-bs-target="#addModel">
                                <span class="fas fa-plus me-2"></span>Phòng ban
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover table-sm fs-9 mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort align-middle text-start" scope="col" data-sort="customer" style="max-width:160px">Tên phòng ban</th>
                                    <th class="sort align-middle text-start" scope="col" data-sort="customer" style="max-width:160px">Số lượng nhân viên</th>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="row g-3" id="formAdd" method="POST">
                                    <p class="m-0 mt-2 ps-2">----------------------------Phòng ban-----------------------------</p>

                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-floating">
                                            <input class="form-control data-value data-validate" name="name" type="text" placeholder="tên phòng ban" />
                                    ...
                                    <div class="col-12 gy-6">
                                        <div class="row g-3 justify-content-center">
                                            <div class="col-auto">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-submit mx-1" title="Thêm phòng ban">Thêm phòng ban</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                    ...
                                    <div class="col-12 gy-6">
                                        <div class="row g-3 justify-content-center">
                                            <div class="col-auto">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-submit mx-1" title="Sửa phòng ban">Sửa phòng ban</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
            ...
            <script src="./inc/scripts/departments.js"></script>
            <!-- Footer-->
