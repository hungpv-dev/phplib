        ...
        <div class="content">
            <nav class="mb-2" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">Quản lý đơn vị tính</li>
                </ol>
            </nav>
            <h2 class="text-bold text-body-emphasis mb-5">Quản lý đơn vị tính</h2>
            <div>
                <!-- Search -->
                    ...
                    <div class="col-auto">
                        <div class="d-flex align-items-center ">
                            ...
                            <button class="btn btn-primary px-3" data-bs-toggle="modal" data-bs-target="#addModel">
                                <span class="fas fa-plus me-2"></span>Đơn vị tính
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover table-sm fs-9 mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort align-middle text-center" scope="col" data-sort="customer" style="max-width:160px">Tên Đơn vị tính</th>
                                    <th class="sort align-middle text-center" scope="col" data-sort="customer" style="max-width:160px">Loại hình</th>
                                    <th class="sort align-middle text-center" scope="col" data-sort="status">Hành động</th>
                                </tr>
                            </thead>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="row g-3" id="formAdd" method="POST">
                                    <p class="m-0 mt-2 ps-2">------------------------------Đơn vị tính---------------------------</p>

                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-floating">
                                            <input class="form-control data-value data-validate" name="name" type="text" placeholder="tên Đơn vị tính" />
                                            <label>Tên Đơn vị tính</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-floating">
                                            <select name="type" title="loại hình" class="form-select data-value data-validate">
                                    ...
                                    <div class="col-12 gy-6">
                                        <div class="row g-3 justify-content-center">
                                            <div class="col-auto">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-submit mx-1" title="Thêm đơn vị tính">Thêm đơn vị tính</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
            ...
            <script src="./inc/scripts/units.js"></script>
            <!-- Footer-->
